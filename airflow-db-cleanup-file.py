...
ALERT_EMAIL_ADDRESSES = ['conwunyirigbo@gmail.com']
# Length to retain the log files if not already provided in the conf. If this
# is set to 30, the job will remove those files that arE 30 days old or older.

DEFAULT_MAX_DB_ENTRY_AGE_IN_DAYS = int(
    Variable.get("airflow_db_cleanup__max_db_entry_age_in_days", 4)
)
...
DATABASE_OBJECTS = [
    {
        "airflow_db_model": BaseJobRunner,
        "age_check_column": BaseJobRunner.heartbeat_callback,
        "keep_last": False,
